...
public class JuegoQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_quiz);
    ...
    public void revisionJuego(View view) {
        ...
        if(rb_1.isChecked() == true){
            if(juego.getOp1() == correcta){
                ...
                Toast.makeText(JuegoQuiz.this, "¡Respuesta correcta!", Toast.LENGTH_LONG).show();
                //#1BFF09
            }else{
                rb_1.setBackgroundColor(Color.RED);
                Toast.makeText(JuegoQuiz.this, "Respuesta incorrecta, intenta otra vez", Toast.LENGTH_SHORT).show();
            }
            ...
            Toast.makeText(JuegoQuiz.this, "Por favor seleccione una opción", Toast.LENGTH_SHORT).show();
        }
    }
